...
const EmployeeHomeNavBar = () =>{
    ...
    return <>
        <nav className="navbar navbar-expand-md" style={{backgroundColor: '#b234fa'}}>
            <a className="navbar-brand" href="/ems/employee/home" style={{fontWeight: "bold"}}>
            ...
            <div className="collapse navbar-collapse justify-content-end mr-4" id="navbarNav">
                ...
                <li className="nav-item">
                        <Link className="nav-link" to="/ems/employee/home">Home</Link>
                    </li>
                    {/* <li className="nav-item">
...
export default EmployeeHomeNavBar;